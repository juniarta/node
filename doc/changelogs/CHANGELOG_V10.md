...
* [[`8353a21abe`](https://github.com/nodejs/node/commit/8353a21abe)] - **benchmark**: fix net-wrap-js-stream-passthrough (Rich Trott) [#25273](https://github.com/nodejs/node/pull/25273)
...
* [[`3d55b6123a`](https://github.com/nodejs/node/commit/3d55b6123a)] - **build**: make compress\_json python3 compatible (Sakthipriyan Vairamani (thefourtheye)) [#25582](https://github.com/nodejs/node/pull/25582)
* [[`29e360216a`](https://github.com/nodejs/node/commit/29e360216a)] - **build**: make configure.py compatible with python 3 (Sakthipriyan Vairamani (thefourtheye)) [#25580](https://github.com/nodejs/node/pull/25580)
* [[`f449608a20`](https://github.com/nodejs/node/commit/f449608a20)] - **build**: remove AIX/ppc (32bit) dead code (Refael Ackermann) [#25523](https://github.com/nodejs/node/pull/25523)
* [[`b8aca29fba`](https://github.com/nodejs/node/commit/b8aca29fba)] - **build**: remove erroneous duplicate declaration from node\_inspector.gypi (Refael Ackermann) [#25586](https://github.com/nodejs/node/pull/25586)
* [[`b9e876045d`](https://github.com/nodejs/node/commit/b9e876045d)] - **build**: do not lint python scripts under test/fixtures (Joyee Cheung) [#25639](https://github.com/nodejs/node/pull/25639)
* [[`356b64be5b`](https://github.com/nodejs/node/commit/356b64be5b)] - **build**: add check for empty openssl-fips flag (Daniel Bevenius) [#25391](https://github.com/nodejs/node/pull/25391)
* [[`ec704a1472`](https://github.com/nodejs/node/commit/ec704a1472)] - **build**: fix Windows shared lib build (Richard Lau) [#25166](https://github.com/nodejs/node/pull/25166)
* [[`0cd9ac2250`](https://github.com/nodejs/node/commit/0cd9ac2250)] - **build**: correct fi indentation in Makefile (Daniel Bevenius) [#25107](https://github.com/nodejs/node/pull/25107)
...
* [[`cd70a8249e`](https://github.com/nodejs/node/commit/cd70a8249e)] - **child_process**: truncate output when maxBuffer is exceeded (Jeremiah Senkpiel) [#24951](https://github.com/nodejs/node/pull/24951)
* [[`1f57273324`](https://github.com/nodejs/node/commit/1f57273324)] - **child_process**: simplify argument handling (cjihrig) [#25194](https://github.com/nodejs/node/pull/25194)
...
* [[`2b73f96d15`](https://github.com/nodejs/node/commit/2b73f96d15)] - **crypto**: add crypto modules to cannotUseCache (Daniel Bevenius) [#25606](https://github.com/nodejs/node/pull/25606)
* [[`83b0ba4aa4`](https://github.com/nodejs/node/commit/83b0ba4aa4)] - **crypto**: add crypto/keys to cannotUseCache (Daniel Bevenius) [#25237](https://github.com/nodejs/node/pull/25237)
* [[`6e8bc27b0a`](https://github.com/nodejs/node/commit/6e8bc27b0a)] - **crypto**: update root certificates (Sam Roberts) [#25113](https://github.com/nodejs/node/pull/25113)
* [[`f9c4a19303`](https://github.com/nodejs/node/commit/f9c4a19303)] - **(SEMVER-MINOR)** **deps**: upgrade npm to 6.5.0 (Audrey Eschright) [#24734](https://github.com/nodejs/node/pull/24734)
* [[`3c7596464a`](https://github.com/nodejs/node/commit/3c7596464a)] - **deps**: upgrade to libuv 1.24.1 (cjihrig) [#25078](https://github.com/nodejs/node/pull/25078)
...
* [[`5cc39b8156`](https://github.com/nodejs/node/commit/5cc39b8156)] - **dns**: fix TTL value for AAAA replies to `resolveAny()` (Anna Henningsen) [#25187](https://github.com/nodejs/node/pull/25187)
* [[`38f326fa00`](https://github.com/nodejs/node/commit/38f326fa00)] - **doc**: revise breaking changes material in COLLABORATOR\_GUIDE (Rich Trott) [#25730](https://github.com/nodejs/node/pull/25730)
* [[`f51975afd7`](https://github.com/nodejs/node/commit/f51975afd7)] - **doc**: fix http.Agent timeout option description (Luigi Pinca) [#25489](https://github.com/nodejs/node/pull/25489)
* [[`f5e2207399`](https://github.com/nodejs/node/commit/f5e2207399)] - **doc**: fix file extension on ESM file example (Eric Whitebloom) [#25692](https://github.com/nodejs/node/pull/25692)
* [[`905f0f03b6`](https://github.com/nodejs/node/commit/905f0f03b6)] - **doc**: remove outdated s\_client information in tls.md (Rich Trott) [#25678](https://github.com/nodejs/node/pull/25678)
* [[`6d49ad1e7f`](https://github.com/nodejs/node/commit/6d49ad1e7f)] - **doc**: clarify what dns.setResolvers() affects (Sam Roberts) [#25570](https://github.com/nodejs/node/pull/25570)
* [[`f0cbd67a1a`](https://github.com/nodejs/node/commit/f0cbd67a1a)] - **doc**: simplify process.binding() deprecation message (Rich Trott) [#25654](https://github.com/nodejs/node/pull/25654)
* [[`0ea7fe8066`](https://github.com/nodejs/node/commit/0ea7fe8066)] - **doc**: add note regarding pushing release tags (Myles Borins) [#25569](https://github.com/nodejs/node/pull/25569)
* [[`9edd1a93ee`](https://github.com/nodejs/node/commit/9edd1a93ee)] - **doc**: reword stream docs to clarify that decodeStrings encodes strings (Daniel George Holz) [#25468](https://github.com/nodejs/node/pull/25468)
* [[`8d309dc5d4`](https://github.com/nodejs/node/commit/8d309dc5d4)] - **doc**: correct my wrong note about buf.fill() (Vse Mozhet Byt) [#25585](https://github.com/nodejs/node/pull/25585)
* [[`d5739af8f1`](https://github.com/nodejs/node/commit/d5739af8f1)] - **doc**: add a note to `buf.fill()` description (Vse Mozhet Byt) [#25547](https://github.com/nodejs/node/pull/25547)
* [[`e323ddaef8`](https://github.com/nodejs/node/commit/e323ddaef8)] - **doc**: fix typo in Buffer API (H1Gdev) [#25544](https://github.com/nodejs/node/pull/25544)
* [[`7f5d6b9837`](https://github.com/nodejs/node/commit/7f5d6b9837)] - **doc**: add Rich back to TSC list (Michael Dawson) [#25535](https://github.com/nodejs/node/pull/25535)
* [[`814f26106e`](https://github.com/nodejs/node/commit/814f26106e)] - **doc**: add metadata about ecdh curve options (Sam Roberts) [#25502](https://github.com/nodejs/node/pull/25502)
* [[`b0e288af53`](https://github.com/nodejs/node/commit/b0e288af53)] - **doc**: add TLSSocket.isSessionReused() docs (Sam Roberts) [#25423](https://github.com/nodejs/node/pull/25423)
* [[`222f98df74`](https://github.com/nodejs/node/commit/222f98df74)] - **doc**: fix sorting in buffer.md (Vse Mozhet Byt) [#25477](https://github.com/nodejs/node/pull/25477)
* [[`e8271a4bd4`](https://github.com/nodejs/node/commit/e8271a4bd4)] - **doc**: fix `napi\_open\_callback\_scope` description (Philipp Renoth) [#25366](https://github.com/nodejs/node/pull/25366)
* [[`f7491d45c0`](https://github.com/nodejs/node/commit/f7491d45c0)] - **doc**: document that stream.on('close') was changed in Node 10 (Matteo Collina) [#25413](https://github.com/nodejs/node/pull/25413)
* [[`26e6a2445a`](https://github.com/nodejs/node/commit/26e6a2445a)] - **doc**: fix the path to postMessage() (Mitar) [#25332](https://github.com/nodejs/node/pull/25332)
* [[`614edcba58`](https://github.com/nodejs/node/commit/614edcba58)] - **doc**: update `os.networkInterfaces()` example (jvelezpo) [#25417](https://github.com/nodejs/node/pull/25417)
* [[`58753364f4`](https://github.com/nodejs/node/commit/58753364f4)] - **doc**: make sure that calls to .read() are looped (Matteo Collina) [#25375](https://github.com/nodejs/node/pull/25375)
* [[`abacd1e4a9`](https://github.com/nodejs/node/commit/abacd1e4a9)] - **doc**: add history to http.request.setTimeout() (James Bunton) [#25121](https://github.com/nodejs/node/pull/25121)
* [[`745284f2e3`](https://github.com/nodejs/node/commit/745284f2e3)] - **doc**: add clarification for exception behaviour (Michael Dawson) [#25339](https://github.com/nodejs/node/pull/25339)
* [[`f84317fb69`](https://github.com/nodejs/node/commit/f84317fb69)] - **doc**: clarify timing of socket.connecting (Sam Roberts) [#25333](https://github.com/nodejs/node/pull/25333)
* [[`27f3dba3bf`](https://github.com/nodejs/node/commit/27f3dba3bf)] - **doc**: update benchmark doc (Kazushi Kitaya) [#25367](https://github.com/nodejs/node/pull/25367)
* [[`094a7cc402`](https://github.com/nodejs/node/commit/094a7cc402)] - **doc**: use lowercase for zlib (Rich Trott) [#25371](https://github.com/nodejs/node/pull/25371)
* [[`f9230b14fe`](https://github.com/nodejs/node/commit/f9230b14fe)] - **doc**: fix heading in cpp style guide (Kazushi Kitaya) [#25303](https://github.com/nodejs/node/pull/25303)
* [[`28741ebcec`](https://github.com/nodejs/node/commit/28741ebcec)] - **doc**: fix process.stdin example (Anna Henningsen) [#25344](https://github.com/nodejs/node/pull/25344)
* [[`471776760a`](https://github.com/nodejs/node/commit/471776760a)] - **doc**: fs.mkdir('/') throws EPERM on Windows (Corey Farrell) [#25340](https://github.com/nodejs/node/pull/25340)
* [[`eebcb8be15`](https://github.com/nodejs/node/commit/eebcb8be15)] - **doc**: include license for src/large\_pages in LICENSE (Ujjwal Sharma) [#25246](https://github.com/nodejs/node/pull/25246)
* [[`45894d6b70`](https://github.com/nodejs/node/commit/45894d6b70)] - **doc**: describe TLS session resumption (Sam Roberts) [#25174](https://github.com/nodejs/node/pull/25174)
* [[`7f247fd702`](https://github.com/nodejs/node/commit/7f247fd702)] - **doc**: link and expand --tls-cipher-list docs (Sam Roberts) [#25174](https://github.com/nodejs/node/pull/25174)
* [[`f3cfbdfb60`](https://github.com/nodejs/node/commit/f3cfbdfb60)] - **doc**: revise "Breaking Changes to Internal Elements" (Rich Trott) [#25190](https://github.com/nodejs/node/pull/25190)
* [[`35ed499d2e`](https://github.com/nodejs/node/commit/35ed499d2e)] - **doc**: fix NAPI typo (Philipp Renoth) [#25216](https://github.com/nodejs/node/pull/25216)
* [[`58dbca5263`](https://github.com/nodejs/node/commit/58dbca5263)] - **doc**: revise "Breaking Changes and Deprecations" (Rich Trott) [#25116](https://github.com/nodejs/node/pull/25116)
* [[`a5c77c1d1a`](https://github.com/nodejs/node/commit/a5c77c1d1a)] - **doc**: describe root cert update process (Sam Roberts) [#25113](https://github.com/nodejs/node/pull/25113)
...
* [[`326634cac6`](https://github.com/nodejs/node/commit/326634cac6)] - **events**: show inspected error in uncaught 'error' message (Anna Henningsen) [#25621](https://github.com/nodejs/node/pull/25621)
* [[`98ef8a48b6`](https://github.com/nodejs/node/commit/98ef8a48b6)] - **events**: simplify stack compare function (Ruben Bridgewater) [#24744](https://github.com/nodejs/node/pull/24744)
...
* [[`e842dccdca`](https://github.com/nodejs/node/commit/e842dccdca)] - **http**: make ClientRequest#setTimeout() noop at end (Tim De Pauw) [#25536](https://github.com/nodejs/node/pull/25536)
* [[`ff30a37e05`](https://github.com/nodejs/node/commit/ff30a37e05)] - **http**: reuse noop function in socketOnError() (cjihrig) [#25566](https://github.com/nodejs/node/pull/25566)
...
* [[`48ff32fe38`](https://github.com/nodejs/node/commit/48ff32fe38)] - **http2**: allow fully synchronous `\_final()` (Anna Henningsen) [#25609](https://github.com/nodejs/node/pull/25609)
* [[`c18366f8fb`](https://github.com/nodejs/node/commit/c18366f8fb)] - **http2**: add test case for goaway (Anto Aravinth) [#24054](https://github.com/nodejs/node/pull/24054)
...
* [[`3babfdf813`](https://github.com/nodejs/node/commit/3babfdf813)] - **inspector, test**: verify reported console message (Eugene Ostroukhov) [#25455](https://github.com/nodejs/node/pull/25455)
* [[`43dd99cf91`](https://github.com/nodejs/node/commit/43dd99cf91)] - **(SEMVER-MINOR)** **lib**: support overriding http\\s.globalAgent (Roy Sommer) [#25170](https://github.com/nodejs/node/pull/25170)
* [[`a5b0fbde77`](https://github.com/nodejs/node/commit/a5b0fbde77)] - **lib**: simplify several debug() calls (cjihrig) [#25241](https://github.com/nodejs/node/pull/25241)
...
* [[`a7ab3f2ff1`](https://github.com/nodejs/node/commit/a7ab3f2ff1)] - **lib,test**: remove lib/internal/test/unicode.js (Rich Trott) [#25298](https://github.com/nodejs/node/pull/25298)
* [[`9101d9368f`](https://github.com/nodejs/node/commit/9101d9368f)] - **module**: revert module.\_compile to original state if module is patched (Ujjwal Sharma) [#21573](https://github.com/nodejs/node/pull/21573)
* [[`8f84ae05f6`](https://github.com/nodejs/node/commit/8f84ae05f6)] - **module**: use compileFunction over Module.wrap (Ujjwal Sharma) [#21573](https://github.com/nodejs/node/pull/21573)
...
* [[`4598ed72cd`](https://github.com/nodejs/node/commit/4598ed72cd)] - **net**: check for close on stream, not parent (David Halls) [#25026](https://github.com/nodejs/node/pull/25026)
* [[`ba519913f9`](https://github.com/nodejs/node/commit/ba519913f9)] - **os**: use uv\_os\_gethostname() in hostname() (cjihrig) [#25111](https://github.com/nodejs/node/pull/25111)
* [[`9558901756`](https://github.com/nodejs/node/commit/9558901756)] - **perf_hooks**: clean up GC listeners (Anna Henningsen) [#25647](https://github.com/nodejs/node/pull/25647)
...
* [[`dcff288977`](https://github.com/nodejs/node/commit/dcff288977)] - **repl**: improve doc for disabling REPL history on Windows (Samuel D. Leslie) [#25672](https://github.com/nodejs/node/pull/25672)
* [[`139dd59331`](https://github.com/nodejs/node/commit/139dd59331)] - **repl**: indicate if errors are thrown or not (Ruben Bridgewater) [#25253](https://github.com/nodejs/node/pull/25253)
...
* [[`0c3dbc76a2`](https://github.com/nodejs/node/commit/0c3dbc76a2)] - **src**: remove unused field in node\_http2.h (gengjiawen) [#25727](https://github.com/nodejs/node/pull/25727)
* [[`b930be07ab`](https://github.com/nodejs/node/commit/b930be07ab)] - **src**: remove unnecessary call to SSL\_get\_mode (Sam Roberts) [#25711](https://github.com/nodejs/node/pull/25711)
* [[`44b954516f`](https://github.com/nodejs/node/commit/44b954516f)] - **src**: fix macro duplicate declaration in env.h (gengjiawen) [#25703](https://github.com/nodejs/node/pull/25703)
* [[`1d2d3f3946`](https://github.com/nodejs/node/commit/1d2d3f3946)] - **src**: remove outdated `Neuter()` call in `node\_buffer.cc` (Anna Henningsen) [#25479](https://github.com/nodejs/node/pull/25479)
* [[`2c2d71c9c7`](https://github.com/nodejs/node/commit/2c2d71c9c7)] - **src**: trace\_events: fix race with metadata events (Ali Ijaz Sheikh) [#25235](https://github.com/nodejs/node/pull/25235)
* [[`71c3d2e292`](https://github.com/nodejs/node/commit/71c3d2e292)] - **src**: remove unused method declaration (Ben Noordhuis) [#25329](https://github.com/nodejs/node/pull/25329)
* [[`6ab84e3ca5`](https://github.com/nodejs/node/commit/6ab84e3ca5)] - **src**: remove unused variable from string\_search.h (Anna Henningsen) [#25139](https://github.com/nodejs/node/pull/25139)
* [[`96a57a76e0`](https://github.com/nodejs/node/commit/96a57a76e0)] - **src**: do not leak NodeTraceStateObserver (Anna Henningsen) [#25180](https://github.com/nodejs/node/pull/25180)
* [[`2fa178f3af`](https://github.com/nodejs/node/commit/2fa178f3af)] - **src**: port GetLoadedLibraries for freebsd (Gireesh Punathil) [#25106](https://github.com/nodejs/node/pull/25106)
...
* [[`0f34794212`](https://github.com/nodejs/node/commit/0f34794212)] - **test**: rewrite fs {f}utimes test file (Jeremiah Senkpiel) [#25656](https://github.com/nodejs/node/pull/25656)
* [[`1eb38b0b4f`](https://github.com/nodejs/node/commit/1eb38b0b4f)] - **test**: remove unused uncaughtException handler (Anna Henningsen) [#25641](https://github.com/nodejs/node/pull/25641)
* [[`d744de4ee8`](https://github.com/nodejs/node/commit/d744de4ee8)] - **test**: fix sequential/test-performance delay (Anatoli Papirovski) [#25695](https://github.com/nodejs/node/pull/25695)
* [[`1cc771e4b8`](https://github.com/nodejs/node/commit/1cc771e4b8)] - **test**: remove common.isOSXMojave (Rich Trott) [#25658](https://github.com/nodejs/node/pull/25658)
* [[`5e64e86421`](https://github.com/nodejs/node/commit/5e64e86421)] - **test**: remove known\_issues/test-cluster-bind-privileged-port (Rich Trott) [#25649](https://github.com/nodejs/node/pull/25649)
* [[`befb57ac73`](https://github.com/nodejs/node/commit/befb57ac73)] - **test**: fix pummel/test-exec (Rich Trott) [#25677](https://github.com/nodejs/node/pull/25677)
* [[`d79ae1408c`](https://github.com/nodejs/node/commit/d79ae1408c)] - **test**: add stdio checks to cp-exec-maxBuffer (Jeremiah Senkpiel) [#24951](https://github.com/nodejs/node/pull/24951)
* [[`df179d7ba8`](https://github.com/nodejs/node/commit/df179d7ba8)] - **test**: revoke flaky designation for tests (Gireesh Punathil) [#25611](https://github.com/nodejs/node/pull/25611)
* [[`1427d75950`](https://github.com/nodejs/node/commit/1427d75950)] - **test**: remove potential race condition in https renegotiation test (Rich Trott) [#25601](https://github.com/nodejs/node/pull/25601)
* [[`c0f929429a`](https://github.com/nodejs/node/commit/c0f929429a)] - **test**: replace common.PORT with `0` in https renegotiation test (Rich Trott) [#25599](https://github.com/nodejs/node/pull/25599)
* [[`f76c8dfd24`](https://github.com/nodejs/node/commit/f76c8dfd24)] - **test**: changed function to arrow function (yathamravali) [#25441](https://github.com/nodejs/node/pull/25441)
* [[`9deacb6c02`](https://github.com/nodejs/node/commit/9deacb6c02)] - **test**: use stronger curves for keygen (Daniel Bevenius) [#25564](https://github.com/nodejs/node/pull/25564)
* [[`1557274164`](https://github.com/nodejs/node/commit/1557274164)] - **test**: relax chunk count expectations (Gireesh Punathil) [#25415](https://github.com/nodejs/node/pull/25415)
* [[`46ddcab7e9`](https://github.com/nodejs/node/commit/46ddcab7e9)] - **test**: improve code coverage for i18n (Michael Dawson) [#25428](https://github.com/nodejs/node/pull/25428)
* [[`5641669695`](https://github.com/nodejs/node/commit/5641669695)] - **test**: use fipsMode instead of common.hasFipsCrypto (Daniel Bevenius) [#25510](https://github.com/nodejs/node/pull/25510)
* [[`684aa5cc14`](https://github.com/nodejs/node/commit/684aa5cc14)] - **test**: do not use uninitialized memory in common flags check (Anna Henningsen) [#25475](https://github.com/nodejs/node/pull/25475)
* [[`51fb7e7913`](https://github.com/nodejs/node/commit/51fb7e7913)] - **test**: prepare test-hash-seed for CI (Rich Trott) [#25522](https://github.com/nodejs/node/pull/25522)
* [[`382ec16463`](https://github.com/nodejs/node/commit/382ec16463)] - **test**: refactor min() in test-hash-seed (Rich Trott) [#25522](https://github.com/nodejs/node/pull/25522)
* [[`8294e6efaa`](https://github.com/nodejs/node/commit/8294e6efaa)] - **test**: add check for wrk to test-keep-alive (Rich Trott) [#25516](https://github.com/nodejs/node/pull/25516)
* [[`637e8768e5`](https://github.com/nodejs/node/commit/637e8768e5)] - **test**: fix test-repl timeout and tmpdir refresh (Brian White) [#25425](https://github.com/nodejs/node/pull/25425)
* [[`788df29745`](https://github.com/nodejs/node/commit/788df29745)] - **test**: refactor pummel/test-net-pingpong (Rich Trott) [#25485](https://github.com/nodejs/node/pull/25485)
* [[`483cef1bad`](https://github.com/nodejs/node/commit/483cef1bad)] - **test**: refactor pummel/test-net-many-clients (Rich Trott) [#25485](https://github.com/nodejs/node/pull/25485)
* [[`c13ec3aac0`](https://github.com/nodejs/node/commit/c13ec3aac0)] - **test**: refactor pummel/test-net-connect-econnrefused (Rich Trott) [#25485](https://github.com/nodejs/node/pull/25485)
* [[`94c4d18b31`](https://github.com/nodejs/node/commit/94c4d18b31)] - **test**: refactor pummel/test-keep-alive (Rich Trott) [#25485](https://github.com/nodejs/node/pull/25485)
* [[`5b1b071beb`](https://github.com/nodejs/node/commit/5b1b071beb)] - **test**: add test for fs.lchmod (ZYSzys) [#25439](https://github.com/nodejs/node/pull/25439)
* [[`4eaaeb5b88`](https://github.com/nodejs/node/commit/4eaaeb5b88)] - **test**: rework ephemeralkeyinfo to run in parallel (Sam Roberts) [#25409](https://github.com/nodejs/node/pull/25409)
* [[`7ca66254c5`](https://github.com/nodejs/node/commit/7ca66254c5)] - **test**: check for tls renegotiation errors (Sam Roberts) [#25437](https://github.com/nodejs/node/pull/25437)
* [[`0f924d3fb2`](https://github.com/nodejs/node/commit/0f924d3fb2)] - **test**: fix test-net-connect-econnrefused (again) (Rich Trott) [#25438](https://github.com/nodejs/node/pull/25438)
* [[`ada148db36`](https://github.com/nodejs/node/commit/ada148db36)] - **test**: remove unnecessary skipIfWorker() (Rich Trott) [#25427](https://github.com/nodejs/node/pull/25427)
* [[`caf89650a4`](https://github.com/nodejs/node/commit/caf89650a4)] - **test**: improve test coverage of native crypto code (Tobias Nießen) [#25400](https://github.com/nodejs/node/pull/25400)
* [[`d738fe8243`](https://github.com/nodejs/node/commit/d738fe8243)] - **test**: move require('https') to after crypto check (Daniel Bevenius) [#25388](https://github.com/nodejs/node/pull/25388)
* [[`c190a2ab89`](https://github.com/nodejs/node/commit/c190a2ab89)] - **test**: fix test-net-connect-econnrefused (Rich Trott) [#25389](https://github.com/nodejs/node/pull/25389)
* [[`171f42fb1d`](https://github.com/nodejs/node/commit/171f42fb1d)] - **test**: remove test/pummel/test-http-client-reconnect-bug.js (Rich Trott) [#25387](https://github.com/nodejs/node/pull/25387)
* [[`62d93d6491`](https://github.com/nodejs/node/commit/62d93d6491)] - **test**: refactor test-fs-watch-non-recursive (Rich Trott) [#25386](https://github.com/nodejs/node/pull/25386)
* [[`4338f98b70`](https://github.com/nodejs/node/commit/4338f98b70)] - **test**: fix test/pummel/test-fs-watch-non-recursive.js (Rich Trott) [#25386](https://github.com/nodejs/node/pull/25386)
* [[`b2b5474538`](https://github.com/nodejs/node/commit/b2b5474538)] - **test**: fix test/pummel/test-fs-watch-file.js (Rich Trott) [#25384](https://github.com/nodejs/node/pull/25384)
* [[`d0f56b535f`](https://github.com/nodejs/node/commit/d0f56b535f)] - **test**: fix test/pummel/test-fs-largefile.js (Rich Trott) [#25372](https://github.com/nodejs/node/pull/25372)
* [[`8707290d8d`](https://github.com/nodejs/node/commit/8707290d8d)] - **test**: more tests for internal/util/types (ZYSzys) [#25225](https://github.com/nodejs/node/pull/25225)
* [[`7e31693c2e`](https://github.com/nodejs/node/commit/7e31693c2e)] - **test**: tune test-uv-threadpool-schedule (Rich Trott) [#25358](https://github.com/nodejs/node/pull/25358)
* [[`88a5aca59d`](https://github.com/nodejs/node/commit/88a5aca59d)] - **test**: remove redundant fchmod test (ZYSzys) [#25282](https://github.com/nodejs/node/pull/25282)
* [[`0d5e54d477`](https://github.com/nodejs/node/commit/0d5e54d477)] - **test**: move test-tls-securepair-client out of pummel (Rich Trott) [#25222](https://github.com/nodejs/node/pull/25222)
* [[`3ce744a78c`](https://github.com/nodejs/node/commit/3ce744a78c)] - **test**: fix test-tls-securepair-client (Rich Trott) [#25222](https://github.com/nodejs/node/pull/25222)
* [[`2936958b89`](https://github.com/nodejs/node/commit/2936958b89)] - **test**: http2 origin length ERR\_HTTP2\_ORIGIN\_LENGTH (Furqan Shaikh) [#25296](https://github.com/nodejs/node/pull/25296)
* [[`04952fdff3`](https://github.com/nodejs/node/commit/04952fdff3)] - **test**: fix test-benchmark-zlib (Rich Trott) [#25365](https://github.com/nodejs/node/pull/25365)
* [[`23a25ff986`](https://github.com/nodejs/node/commit/23a25ff986)] - **test**: set umask explicitly (Thomas Chung) [#25213](https://github.com/nodejs/node/pull/25213)
* [[`59f3c827eb`](https://github.com/nodejs/node/commit/59f3c827eb)] - **test**: make sure tmpdir is created before using it (Joyee Cheung) [#25224](https://github.com/nodejs/node/pull/25224)
* [[`d28003b05d`](https://github.com/nodejs/node/commit/d28003b05d)] - **test**: remove unused --expose-native-as V8 flag (peterwmwong) [#25275](https://github.com/nodejs/node/pull/25275)
* [[`07724feb63`](https://github.com/nodejs/node/commit/07724feb63)] - **test**: mark test-util-callbackify flaky on AIX (Rich Trott) [#25284](https://github.com/nodejs/node/pull/25284)
* [[`700cf06e6a`](https://github.com/nodejs/node/commit/700cf06e6a)] - **test**: slightly refactor test-child-process-execsync (Denys Otrishko) [#25227](https://github.com/nodejs/node/pull/25227)
* [[`5634319b2c`](https://github.com/nodejs/node/commit/5634319b2c)] - **test**: remove try/catch in common.isMainThread (Rich Trott) [#25249](https://github.com/nodejs/node/pull/25249)
* [[`c04c48759e`](https://github.com/nodejs/node/commit/c04c48759e)] - **test**: regression test for uv threadpool congestion (Gireesh Punathil) [#23099](https://github.com/nodejs/node/pull/23099)
* [[`b8efc9d9bc`](https://github.com/nodejs/node/commit/b8efc9d9bc)] - **test**: mark two tests as flaky in AIX (Gireesh Punathil) [#25126](https://github.com/nodejs/node/pull/25126)
* [[`bccb521c78`](https://github.com/nodejs/node/commit/bccb521c78)] - **test**: refactor stdio handling in test-esm-cjs-main (Richard Lau) [#25169](https://github.com/nodejs/node/pull/25169)
* [[`a31532e6e3`](https://github.com/nodejs/node/commit/a31532e6e3)] - **test**: refactor test-esm-namespace.mjs (Rich Trott) [#25117](https://github.com/nodejs/node/pull/25117)
* [[`fb977e7c43`](https://github.com/nodejs/node/commit/fb977e7c43)] - **test**: fix test-tls-session-timeout (Rich Trott) [#25188](https://github.com/nodejs/node/pull/25188)
* [[`fe6043b5e0`](https://github.com/nodejs/node/commit/fe6043b5e0)] - **test**: mark test-trace-events-api-worker-disabled flaky (Rich Trott) [#25197](https://github.com/nodejs/node/pull/25197)
* [[`da6597d1d7`](https://github.com/nodejs/node/commit/da6597d1d7)] - **test**: remove Files: comment processing from Python test runner (Rich Trott) [#25183](https://github.com/nodejs/node/pull/25183)
* [[`684479f155`](https://github.com/nodejs/node/commit/684479f155)] - **test**: add hasCrypto check to common flags check (Daniel Bevenius) [#25147](https://github.com/nodejs/node/pull/25147)
* [[`bc557933ca`](https://github.com/nodejs/node/commit/bc557933ca)] - **test**: verify input flags (Ruben Bridgewater) [#24876](https://github.com/nodejs/node/pull/24876)
...
* [[`f59fe678c4`](https://github.com/nodejs/node/commit/f59fe678c4)] - **(SEMVER-MINOR)** **tls**: make tls.connect() accept a timeout option (Luigi Pinca) [#25517](https://github.com/nodejs/node/pull/25517)
* [[`41e16c112d`](https://github.com/nodejs/node/commit/41e16c112d)] - **tls**: do not confuse TLSSocket and Socket (Sam Roberts) [#25153](https://github.com/nodejs/node/pull/25153)
...
* [[`5024457622`](https://github.com/nodejs/node/commit/5024457622)] - **tools**: make test.py Queue part Python 3 compatible (gengjiawen) [#25701](https://github.com/nodejs/node/pull/25701)
* [[`64d46ee407`](https://github.com/nodejs/node/commit/64d46ee407)] - **tools**: make mkssldef.py Python 3 compatible (Sakthipriyan Vairamani (thefourtheye)) [#25584](https://github.com/nodejs/node/pull/25584)
* [[`ff63107a57`](https://github.com/nodejs/node/commit/ff63107a57)] - **tools**: improve valgrind support (Anna Henningsen) [#25498](https://github.com/nodejs/node/pull/25498)
* [[`8f716f54fa`](https://github.com/nodejs/node/commit/8f716f54fa)] - **tools**: update ESLint to 5.12.1 (cjihrig) [#25573](https://github.com/nodejs/node/pull/25573)
* [[`1287f74c31`](https://github.com/nodejs/node/commit/1287f74c31)] - **tools**: lint for use of internalBinding() (cjihrig) [#25395](https://github.com/nodejs/node/pull/25395)
* [[`05b71f1fab`](https://github.com/nodejs/node/commit/05b71f1fab)] - **tools**: update crypo check rule (cjihrig) [#25399](https://github.com/nodejs/node/pull/25399)
* [[`a7cad5fb35`](https://github.com/nodejs/node/commit/a7cad5fb35)] - **tools**: add openssl-cli to macos-firewall.sh (Daniel Bevenius) [#25385](https://github.com/nodejs/node/pull/25385)
* [[`298441938d`](https://github.com/nodejs/node/commit/298441938d)] - **tools**: update ESLint to 5.12.0 (cjihrig) [#25347](https://github.com/nodejs/node/pull/25347)
* [[`f8610dd3e4`](https://github.com/nodejs/node/commit/f8610dd3e4)] - **tools**: replace NULL with nullptr (Juan José Arboleda) [#25179](https://github.com/nodejs/node/pull/25179)
* [[`ff67c1e708`](https://github.com/nodejs/node/commit/ff67c1e708)] - **tools**: enable no-useless-catch lint rule (cjihrig) [#25236](https://github.com/nodejs/node/pull/25236)
* [[`08c1cf1948`](https://github.com/nodejs/node/commit/08c1cf1948)] - **tools**: update ESLint to 5.11.1 (cjihrig) [#25236](https://github.com/nodejs/node/pull/25236)
* [[`584a5261e9`](https://github.com/nodejs/node/commit/584a5261e9)] - **tools**: update ESLint to 5.11.0 (cjihrig) [#25191](https://github.com/nodejs/node/pull/25191)
* [[`7bb3808239`](https://github.com/nodejs/node/commit/7bb3808239)] - **tools**: update certdata.txt (Sam Roberts) [#25113](https://github.com/nodejs/node/pull/25113)
...
* [[`b49889d749`](https://github.com/nodejs/node/commit/b49889d749)] - **url**: return backslashes from fileURLToPath on win (Kevin Smith) [#25349](https://github.com/nodejs/node/pull/25349)
...
* [[`ad33b51721`](https://github.com/nodejs/node/commit/ad33b51721)] - **util**: fixes type in argument type validation error (Ankur Oberoi) [#25103](https://github.com/nodejs/node/pull/25103)
* [[`64847e3f4a`](https://github.com/nodejs/node/commit/64847e3f4a)] - **util**: fix util.inspect with proxied function (Weijia Wang) [#25244](https://github.com/nodejs/node/pull/25244)
* [[`6d7c2d3ca0`](https://github.com/nodejs/node/commit/6d7c2d3ca0)] - **util**: simplify code (Kazushi Kitaya) [#25162](https://github.com/nodejs/node/pull/25162)
...
* [[`9af9ee5dce`](https://github.com/nodejs/node/commit/9af9ee5dce)] - **win, build**: fix building addons on Windows (Bartosz Sosnowski) [#25108](https://github.com/nodejs/node/pull/25108)
...
* [[`d6b7caf99b`](https://github.com/nodejs/node/commit/d6b7caf99b)] - **worker**: fix nullptr deref after MessagePort deser failure (Anna Henningsen) [#25076](https://github.com/nodejs/node/pull/25076)
